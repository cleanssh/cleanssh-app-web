...
安全的 Android SSH 客户端，支持 AI Agent 远程操作。

## 下载

- [最新版本下载](https://cleanssh.com/download/com.cleanssh.app)
- [产品介绍](https://app.cleanssh.com/)
...
| | |
|---|---|
| ![常用连接](https://cleanssh.github.io/cleanssh-app-web/assets/screenshots/Screenshot_2026-09-07-08-00-30-563_dev.cleanssh.ssh-edit.png) | ![端口转发](https://cleanssh.github.io/cleanssh-app-web/assets/screenshots/Screenshot_2026-09-07-08-00-50-788_dev.cleanssh.ssh-edit.png) |
| 常用连接 | 端口转发 |
| ![身份管理](https://cleanssh.github.io/cleanssh-app-web/assets/screenshots/Screenshot_2026-09-07-08-01-21-324_dev.cleanssh.ssh-edit.png) | ![我的](https://cleanssh.github.io/cleanssh-app-web/assets/screenshots/Screenshot_2026-09-07-08-01-33-526_dev.cleanssh.ssh-edit.png) |
| 身份管理 | 我的 |

## 功能

- SSH 终端
- AI Agent 支持（OpenCode、Claude、Codex）
- 连接管理
- 端口转发
- Snippets
- TOTP 认证
